(function(){
    ...
    var userLang = (localStorage.getItem('userLang') != null) ? localStorage.getItem('userLang') : 'en';
    var userLevel = (localStorage.getItem('userLevel') != null) ? localStorage.getItem('userLevel') : 3;
    ...
    function loadHistory() {
        ...
        if(resultHistory !== null) {
            ...
            for (var key in resultHistory) {
                ...
                elemCont += '<div class="'+ key +'"><i class="material-icons">star</i>';
    ...
    function getRand() {
        ...
        while(unicZn){
            ...
            if (rand1 != rand2 && rand1 != rand3 && rand1 != rand4 && rand1 != rand5 && rand2 != rand3 && rand2 != rand4 && rand2 != rand5 && rand3 != rand4 && rand3 != rand5 && rand4 != rand5){
    ...
    function clickEnter() {
        ...
        elem.innerHTML = '<span>' + countUg + '</span><span>' + countNm + '</span><span>' + choosNum.join('') + '</span>';
    ...
    function mainFunc() {
        ...
        for(var i = 0; i < userLevel; i++){
            for(var j = 0; j < userLevel; j++){//проверяем сколько угадано
